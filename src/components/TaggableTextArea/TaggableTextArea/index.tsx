  ...
  ({ value, availableTags, onChange, className }, ref) => {
    ...
    useEffect(() => {
      ...
      const handleKeyDown = (e: React.KeyboardEvent<HTMLDivElement>) => {
          if (e.key === 'Enter') {
              e.preventDefault(); // Estää oletusarvoisen Enter-toiminnon
              ...
              range.deleteContents(); // Poistaa valitun tekstin, jos sellaista on
              range.insertNode(brElement);

              // Siirrä kursori uuden br-elementin jälkeen
